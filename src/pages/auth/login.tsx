          ...
          <div className="flex flex-col justify-center gap-6 md:p-[5%] md:py-[5%] py-[80px]">
            ...
            <Formik
              ...
              onSubmit={(values, { setSubmitting }) => {
                login(values.email, values.password, callbackURL || "/account");
                setSubmitting(false);
              }}
            >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col w-full gap-6">
                  ...
                  <div className="flex justify-between items-center w-full">
                    <div className="text-center flex gap-1 items-center">
                      <Checkbox id="remember" check={rememberMe} onCheck={(value) => setRememberMe(value)} />
                      <label htmlFor="remember">Remember me</label>
                    </div>
                    <Link to="/forgot-password" className="text-primary text-[14px]">
                      Forgot Password?
                    </Link>
                  </div>
            ...
            <Link to="/register" className="text-center mt-4 text-[14px]">
