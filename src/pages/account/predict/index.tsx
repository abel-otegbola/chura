                            ...
                            {({
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col w-full overflow-x-hidden gap-6">
                                    <div className={`flex w-[480%] gap-[5.5%] overflow-hidden`}>
                                        ...
                                        <div className={`w-[80%] flex flex-col gap-5 transition-all duration-500 ${flow === 1 ? "translate-x-[-126.25%] opacity-[1]" : flow < 1 ? "opacity-0 translate-x-[120%]" : "opacity-0 translate-x-[-360%]"}`}>
                                            <div className="flex flex-col gap-3">
                                                <label className="font-bold text-[12px]">
                                        ...
                                        <div className={`w-[80%] flex flex-col gap-5 transition-all duration-500 ${flow === 2 ? "translate-x-[-252.75%] opacity-[1]" : flow < 2 ? "opacity-0 translate-x-[120%]" : "opacity-0 translate-x-[-360%]"}`}>
                                        ...
                                        <div className={`w-[80%] flex flex-col gap-5 transition-all duration-500 ${flow === 3 ? "translate-x-[-378.75%] opacity-[1]" : flow < 3 ? "opacity-0 translate-x-[120%]" : "opacity-0 translate-x-[-120%]"}`}>
